...
public class Falcatus extends AbstractFish implements GeoEntity, IFish {

    public Falcatus(EntityType<? extends AbstractFish> p_27557_, Level p_27558_) {
        super(p_27557_, p_27558_);
    }

    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 10.0F).add(Attributes.MOVEMENT_SPEED, 0.55F);
    }
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(OOItems.FALCATUS_BUCKET.get());
    }
}
