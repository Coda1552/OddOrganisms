...
public class OOBlocks {
    ...
    public static final RegistryObject<Block> EOLACTORIA_EGGS = BLOCKS.register("eolactoria_eggs", () -> new EolactoriaEggsBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).instabreak().noLootTable().noOcclusion().noCollission()));
}
