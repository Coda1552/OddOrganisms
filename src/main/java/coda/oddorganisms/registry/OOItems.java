...
public class OOItems {
    ...
    public static final RegistryObject<Item> DOEDICURUS_SCUTE = ITEMS.register("doedicurus_scute", () -> new Item(new Item.Properties()));
    //public static final RegistryObject<Item> PHEROMONAL_SPRAY = ITEMS.register("pheromonal_spray", () -> new PheromonalSprayItem(new Item.Properties().stacksTo(1).durability(24)));

    public static final RegistryObject<Item> DAWN_HORSE_FLASK = ITEMS.register("dawn_horse_flask", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> DOEDICURUS_FLASK = ITEMS.register("doedicurus_flask", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> EOLACTORIA_FLASK = ITEMS.register("eolactoria_flask", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> APTHOROBLATTINA_FLASK = ITEMS.register("apthoroblattina_flask", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> LEPTICTIDIUM_EMBRYO = ITEMS.register("leptictidium_embryo", () -> new AnimalAttacherItem(new Item.Properties().stacksTo(16), OOTags.LEPTICTIDIUM_EMBRYO_ATTACH_TO, OOEntities.LEPTICTIDIUM, 1000));
    ...
    public static final RegistryObject<Item> EOLACTORIA_SPAWN_EGG = ITEMS.register("eolactoria_spawn_egg", () -> new ForgeSpawnEggItem(OOEntities.EOLACTORIA, 0x8e5c3c, 0xeda655, new Item.Properties()));
    public static final RegistryObject<Item> APTHOROBLATTINA_SPAWN_EGG = ITEMS.register("apthoroblattina_spawn_egg", () -> new ForgeSpawnEggItem(OOEntities.APTHOROBLATTINA, 0x201e24, 0x453638, new Item.Properties()));
